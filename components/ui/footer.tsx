                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="md:flex md:items-center md:justify-between">
                        ...
                        <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
                            ...
                            {/*LinkedIn*/}
                            <li className="ml-4">
                                <Link href="https://www.linkedin.com/in/nicolas-zheng-344a1b159/"
                                      className="flex justify-center items-center text-sky-800 bg-gray-100 hover:text-sky-800 hover:text-sky-700 rounded-full transition duration-150 ease-in-out"
                                      aria-label="Linkedin">
